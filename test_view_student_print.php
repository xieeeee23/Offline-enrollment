        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Test View Student Print Functionality</h5>
                </div>
                <div class="card-body">
                    <p class="mb-3">Click on a student to test the view student page and print button:</p>
                                ...
                                <?php if (mysqli_num_rows($result) > 0): ?>
                                    <?php while ($student = mysqli_fetch_assoc($result)): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="modules/registrar/view_student.php?id=<?php echo $student['id']; ?>" class="btn btn-sm btn-info" title="View Student">
